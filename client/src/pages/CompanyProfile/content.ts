...
export const hero: ClarificationProps & {
	...
	title:
		"At Global Stock Market (GSM), our mission is to democratize access to global financial markets and empower investors of all backgrounds to achieve their financial goals",
	subtitle:
...
export const history: Pick<ClarificationProps, "subtitle" | "text"> & {
	...
	text: "World Stock Bank was founded in 1965. Its creation was the result of a project conceived by the union of all the Stock Markets worldwide, accompanied by a group of five stockbrokers who subscribed the capital to start the business. The global stock market union, the founding countries were Luxembourg, Ireland, Singapore, Switzerland and its founder, Denmark. The central idea of this project was to have a bank that would promote and strengthen the action of stockbrokers around the world, and thereby control, thereby contributing to the development of the capital market worldwide. The importance of this objective meant that it was expressly reflected in its corporate statute, this being a distinctive feature of Banco de Valores among the entities that make up the Global Financial System, thus giving a balance to all the economies of the countries of the world.",
	img: {
